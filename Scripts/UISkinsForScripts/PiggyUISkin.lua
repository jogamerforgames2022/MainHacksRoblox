...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			Background = Color3.fromRGB(108, 69, 117),
			Topbar = Color3.fromRGB(241, 176, 255),
			Shadow = Color3.fromRGB(16, 11, 20),
			
			NotificationBackground = Color3.fromRGB(20, 6, 48),
			NotificationActionsBackground = Color3.fromRGB(230, 230, 230),
			
			TabBackground = Color3.fromRGB(79, 42, 87),
			TabStroke = Color3.fromRGB(125, 61, 138),
			TabBackgroundSelected = Color3.fromRGB(210, 210, 210),
			TabTextColor = Color3.fromRGB(240, 240, 240),
			SelectedTabTextColor = Color3.fromRGB(50, 50, 50),
			
			ElementBackground = Color3.fromRGB(64, 0, 89),
			ElementBackgroundHover = Color3.fromRGB(105, 0, 145),
			SecondaryElementBackground = Color3.fromRGB(52, 28, 61), -- For labels and paragraphs
			ElementStroke = Color3.fromRGB(218, 94, 255),
			SecondaryElementStroke = Color3.fromRGB(113, 38, 135), -- For labels and paragraphs
			
			SliderBackground = Color3.fromRGB(159, 43, 149),
			SliderProgress = Color3.fromRGB(159, 43, 149),
			SliderStroke = Color3.fromRGB(25, 17, 41),
			
			ToggleBackground = Color3.fromRGB(0, 0, 0),
			ToggleEnabled = Color3.fromRGB(15, 128, 56),
			ToggleDisabled = Color3.fromRGB(1156, 14, 14),
			ToggleEnabledStroke = Color3.fromRGB(0, 255, 21),
			ToggleDisabledStroke = Color3.fromRGB(150, 8, 8),
